export const fallbackPlaces = [
  ...
  {
    _id: "sisodia_rani_garden",
    name: "Sisodia Rani Garden & Palace",
    description: "A royal garden palace with terraced fountains, murals, and romantic pavilion architecture.",
    ...
    category: "Forts & Palaces",
    bestVisitTime: "Morning",
    nearbyFoods: ["Ghat Ke Balaji", "Local Snacks"],
    transportOptions: ["Cab", "Auto"],
    faqs: [
      { q: "Who built Sisodia Rani Garden and Palace?", a: "It was built in 1728 by Maharaja Sawai Jai Singh II for his Udaipur queen, Queen Sisodia." },
      { q: "What architectural features make it famous?", a: "Multi-tiered terrace gardens, cascading water channels, and wall murals depicting Lord Krishna's Radha-Krishna legends." },
      { q: "What is the ticket price for Sisodia Rani Garden?", a: "Entry ticket is ₹50 for Indians and ₹200 for foreign visitors." },
      { q: "What are the opening hours?", a: "The garden palace is open from 8:00 AM to 6:00 PM daily." },
      { q: "Is Sisodia Rani Garden popular for pre-wedding photoshoots?", a: "Yes, its serene royal fountains and arched galleries are popular for pre-wedding photography." },
      { q: "How far is it from Pink City center?", a: "Located on Agra Road, about 6 km east of Ghat Gate (approx 15 mins drive)." },
      { q: "Are fountains functional at the garden?", a: "Fountains run on water pressure during monsoon and peak tourist seasons." },
      { q: "Is parking available at the garden entrance?", a: "Yes, parking for cars and tourist buses is available right outside the main gate." },
      { q: "How much time is required to tour Sisodia Rani Garden?", a: "About 45 minutes to 1 hour." },
      { q: "What other attraction is near Sisodia Rani Garden?", a: "Vidyadhar Garden and Ghat Ki Guni heritage drive are located right next door." }
    ]
  },
  ...
  },
  {
    ...
    transportOptions: ["Walk", "Auto"],
    faqs: [
      { q: "What is Isarlat (Sargasuli) tower in Jaipur?", a: "Built in 1749 by Maharaja Ishwari Singh to commemorate victory over combined Rajput forces, it is Jaipur's tallest historical victory tower." },
      { q: "What does Sargasuli mean?", a: "Sargasuli means 'Tower Reaching to Heaven'." },
      { q: "What is the ticket price for Isarlat?", a: "Entry ticket is ₹50 for Indians and ₹200 for foreign visitors." },
      { q: "How many steps to reach the top of Isarlat tower?", a: "A spiral ramp (no stairs) leads to the top 7-story balcony, offering 360-degree aerial views of the Pink City bazaars." },
      { q: "What are the opening hours of Isarlat?", a: "Open daily from 9:30 AM to 4:30 PM." },
      { q: "Which metro station is closest to Isarlat tower?", a: "Chhoti Chaupar Metro Station is just 300 meters away." },
      { q: "Is there an elevator inside Isarlat?", a: "No, climbing is via a well-lit spiral ramp walkway." },
      { q: "What monuments can be seen from the top of Isarlat?", a: "City Palace, Hawa Mahal, Jantar Mantar, Nahargarh Fort, and Tripolia Bazaar streets." },
      { q: "How much time is required to visit Isarlat?", a: "About 30 to 45 minutes." },
      { q: "What food spots are near Isarlat tower?", a: "Sahu Chai on Chaura Rasta and Samrat Pyaaz Kachori." }
    ]
  },
  ...
  },
  {
    ...
    description: "A beloved temple in the City Palace complex, famous for its daily aartis and world-record flat ceiling.",
    ...
    transportOptions: ["Walk", "Auto"],
    faqs: [
      { q: "Who is the presiding deity of Govind Dev Ji Temple?", a: "Lord Krishna (Govind Dev Ji)—the royal deity of Jaipur rulers, brought from Vrindavan by Raja Man Singh I." },
      { q: "What world record does the temple hall hold?", a: "Satsang Hall holds the Guinness World Record for the widest single-span reinforced concrete flat roof built without pillars!" },
      { q: "What are the daily 7 Aarti timings?", a: "Mangala (5:00 AM), Dhoop (7:45 AM), Shringar (9:30 AM), Gwal (11:00 AM), Rajbhog (11:45 AM), Sandhya (5:45 PM), Shayan (8:30 PM)." },
      { q: "Is entry free at Govind Dev Ji Temple?", a: "Yes, entry and darshan are 100% FREE for all devotees." },
      { q: "Where is the temple located?", a: "Inside Jai Niwas Garden directly behind City Palace." },
      { q: "Which metro station is closest to Govind Dev Ji Temple?", a: "Badi Chaupar or Chhoti Chaupar metro stations (approx 600m walk)." },
      { q: "Is prasad available for devotees?", a: "Yes, authentic Mishri-Makkhan prasad and laddoos are distributed after aartis." },
      { q: "What is Janmashtami celebration like here?", a: "Over 5 lakh devotees visit on Janmashtami to witness grand midnight celebrations and floral Jhulas." },
      { q: "Is footwear storage provided?", a: "Yes, large organized shoe deposit counters operate near all entrance gates." },
      { q: "Is dress code enforced?", a: "Modest traditional attire is recommended out of respect for temple customs." }
    ]
  },
  ...
  },
  {
    _id: "masala_chowk",
    name: "Masala Chowk",
    description: "An open-air food court offering Jaipur's iconic street food stalls under one roof.",
    location: "Ram Niwas Garden, Jaipur",
    images: ["https://res.cloudinary.com/dtaoqmefw/image/upload/f_auto,q_auto/v1779953023/Albert_Hall_Museum_g25y8x.jpg"],
    rating: 4.6,
    ...
    category: "Markets & Bazaars",
    bestVisitTime: "Evening",
    nearbyFoods: ["Samrat Pyaaz Kachori", "Sethia Lassi", "Gulab Ji Chai"],
    transportOptions: ["Walk", "Auto"],
    faqs: [
      { q: "What is Masala Chowk Jaipur?", a: "An open-air food park bringing 21 of Jaipur's oldest, most famous street food legends together in Ram Niwas Garden." },
      { q: "What is the entry ticket fee for Masala Chowk?", a: "Entry token is ₹10 per person." },
      { q: "What famous food stalls operate at Masala Chowk?", a: "Gulab Ji Chai, Samrat Kachori, Sethia Lassi, Mahaveer Rabdi, Bhagat Misthan, and Indian Ice Cream." },
      { q: "What are the opening hours?", a: "Open daily from 1:00 PM to 10:00 PM (busiest from 6:00 PM onwards)." },
      { q: "Where is Masala Chowk located?", a: "Adjacent to Albert Hall Museum inside Ram Niwas Garden." },
      { q: "Is seating available for families?", a: "Yes, spacious outdoor bench seating for 500+ guests with ambient lighting." },
      { q: "Are digital payments (UPI) accepted at all stalls?", a: "Yes, GPay, PhonePe, Paytm, and cards are accepted at all food counters." },
      { q: "Is 100% vegetarian food served?", a: "Yes, all food stalls at Masala Chowk serve pure vegetarian Rajasthani delicacies." },
      { q: "Is parking available nearby?", a: "Yes, Ram Niwas Garden parking is right outside the entrance." },
      { q: "Which metro station is closest?", a: "Railway Station or Chandpole metro stations (2.5 km away)." }
    ]
  },

  // WILDLIFE, PARKS & PHOTOGRAPHY
  {
    _id: "patrika_gate",
    name: "Patrika Gate",
  ...
  },
  {
    ...
    description: "A beautifully landscaped garden at the foothills of Nahargarh with white marble fountains.",
    location: "Amer Road, Jaipur",
    ...
    transportOptions: ["Auto", "Cab"],
    faqs: [
      { q: "What inspired Kanak Vrindavan Garden's design?", a: "Built by Maharaja Sawai Jai Singh II 280 years ago, its layout resembles the mythical Vrindavan gardens where Lord Krishna played." },
      { q: "What is the entry ticket fee for Kanak Vrindavan?", a: "Entry ticket is ₹25 for Indians and ₹50 for foreign tourists." },
      { q: "What movie scenes were filmed at Kanak Vrindavan?", a: "Famous Bollywood films like Hum Saath Saath Hain and Lamhe filmed song sequences here." },
      { q: "What are the visiting hours?", a: "Open daily from 8:00 AM to 5:00 PM." },
      { q: "Where is Kanak Vrindavan located?", a: "At the foot of Nahargarh Hill along Amer Road, right before Jal Mahal." },
      { q: "What temple is situated inside the garden?", a: "Govind Dev Ji's original temple deity was housed in Radha Madhav Temple inside Kanak Vrindavan." },
      { q: "Is it a popular spot for pre-wedding photography?", a: "Yes, its marble fountains and terraced lawns make it a top wedding photo shoot spot." },
      { q: "How much time to spend at Kanak Vrindavan?", a: "30 to 45 minutes." },
      { q: "Is vehicle parking available?", a: "Yes, parking space is available near the entrance along Amer Road." },
      { q: "What snacks are sold nearby?", a: "Tea, roasted corn, ice creams, and Rajasthani kachoris from roadside stalls." }
    ]
  }
];

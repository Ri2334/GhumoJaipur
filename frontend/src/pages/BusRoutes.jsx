      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {selectedRoute && (
          <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 overflow-y-auto">
            <div className="relative w-full max-w-3xl rounded-3xl border border-[#E6D6C3] bg-white p-6 sm:p-8 shadow-2xl space-y-6 my-8 animate-in fade-in zoom-in-95 duration-200">
              
              {/* Modal Close Button */}
              <button
                onClick={() => setSelectedRoute(null)}
                className="absolute right-5 top-5 flex h-9 w-9 items-center justify-center rounded-full bg-[#FAF5EF] text-[#2C1E18] hover:bg-[#B35D38] hover:text-white transition shadow"
              >
                ✕
              </button>
